...
import { createBookService, deleteBookService, editBookService, getBookService, getBooksService, searchBooksService } from "../services/book.service.js"


export const getBooks = async (req, res) => {
    const { page, limit, sort } = req.query
    const { status, message, books } = await getBooksService(parseInt(page), parseInt(limit), sort)
...
export const searchBook = async (req, res) => {
    ...
    const { status, message, books } = await searchBooksService(title) 
